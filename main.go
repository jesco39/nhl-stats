...
func main() {
	...
	mux.HandleFunc("GET /api/game/{id}", handleGame)
	mux.HandleFunc("GET /api/playoff-leaders/skaters", handlePlayoffSkaterLeaders)
	mux.HandleFunc("GET /api/playoff-leaders/goalies", handlePlayoffGoalieLeaders)
